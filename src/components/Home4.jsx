  ...
  return (
    <div className=" h-screen max-w-[100vw] bg-gray-900 p-10 relative ">
      ...
      <img
        src={v9}
        alt=""
        className="h-[20%] hue-rotate-360 absolute bottom-[18%] left-[3%] blur-2xl"
      />
      <img
        src={v9}
        alt=""
        className="h-[30%] hue-rotate-120 absolute bottom-[20%] right-[40%] blur-3xl"
      />
      <div className="h-[60%] w-[60%] flex flex-col p-10 relative ">
        <h1 className="text-white text-7xl font-bold tracking-wider mb-16">
